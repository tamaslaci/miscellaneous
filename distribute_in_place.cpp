...
int distribute_in_place(std::vector<int>& numbers){         // input: N, X[1..N]
...
int main(){
    ...
    std::cout << std::endl;
    std::cout << "Distribute a number sequence in place as evens and odds\n(first part evens, second part odds)" << std::endl;
    std::cout << std::endl;
    ...
    int count = distribute_in_place(numbers);
    std::cout << "< ";
    for(int i : numbers){
        std::cout << i << " ";
    }
    ...
    int count_evens = distribute_in_place(even_numbers);
    std::cout << std::endl;
    ...
    int count_odds = distribute_in_place(odd_numbers);
    std::cout << std::endl;
